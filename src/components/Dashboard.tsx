  ...
  return (
    <div className={`hidden lg:flex flex-col md:flex-row justify-between items-center h-[50px] my-1.5 px-5 md:px-5 ${result}`}>
        ...
        <div className='flex flex-row justify-between relative lg:left-[1em]'>
          ...
          <button onClick={() => setSelect(2)}  className={select === 2 ? 'font-black mx-5 items-center cursor-pointer text-blue-500' : 'font-black mx-5 items-center text-Light-Grayish-Blue cursor-pointer' } onClick={() => setSelect(2)}>Active</button>
